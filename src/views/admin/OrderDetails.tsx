      ...
      <div className="w-full p-4 bg-slate-400 rounded-md">
        ...
        <div className="p-4 ">
          ...
          <div className="flex flex-wrap">
            <div className="w-[30%]">
              <div className="pr-3 text-white text-lg">
                <div className="flex flex-col gap-1">
                  <h2 className="font-semibold">Delivered to: Jesse</h2>
                  <p>
                    <span className="text-sm">This is a Dummy Address</span>
                  </p>
                </div>
            ...
            <div className="w-[70%] ">
              <div className="pl-3 ">
                <div className="mt-4 flex flex-col bg-slate-500 rounded-md p-4">
                  {[1, 2, 3].map((a) => (
